 export default {
  ...
  "rosie": {
    "url": "rosie",
    "title_text": "Rosie",
    "audio_text": "Rosie is the maid and housekeeper of the Jetson family. She is a model XB-500, an older model, but the only one U-Rent A Maid had that Jane could afford. The Jetsons is an American animated sitcom produced by Hanna-Barbera, originally airing in September 23, 1962. While the Flintstones lived in a world which was a comical version of the \"stone age\", with machines powered by birds and dinosaurs, the Jetsons live in a comical version of the future, with elaborate robotic contraptions, aliens, holograms, and whimsical inventions.",
